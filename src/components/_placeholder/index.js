export {default as CharactersWidgetPlaceHolder} from './CharactersWidgetPlaceHolder';
...
export {default as EpisodeDetailPlaceHolder} from './EpisodeDetailPlaceHolder';
